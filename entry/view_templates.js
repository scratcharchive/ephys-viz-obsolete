...
function print_usage() {
  console.log ('Usage:');
  console.log ('ev-view-templates [templates].mda[.prv]');
}
...
params.templates_fname=CLP.unnamedParameters[0];
if (!exists_or_is_url(params.templates_fname)) {
  throw new Error("File does not exist: "+params.templates_fname);
}
var original_templates_fname=params.templates_fname;
params.templates_fname=resolve_prv(params.templates_fname,{search_remote:true});

params.clip_size=CLP.namedParameters['clip_size']||150;
...
function createWindow() {
  ...
  mainWindow = new BrowserWindow({
    ...
    width: width,
    height: height,
    title: 'ephys-viz (view_templates) '+original_templates_fname
  });
  ...
  mainWindow.loadURL(`file://${__dirname}/../src/view_templates.html`);
  if (isDevMode) {
